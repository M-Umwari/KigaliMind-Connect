...
export default function Login() {
 ...
 return await signUp(email,password);
  ...
  return (
    <form method='POST' className='grid h-screen place-content-center  gap-5 text-blue-900  bg-blue-400 font-extrabold'>
      <p className='justify-items-end gap-11'> It's a pleasure you want to join this community </p>
      <br/>
      <br/>
      <br/>
      <br/> 
