    ...
    <>
      ...
      <section className="max-w-7l mx-auto ">
        ...
        <div className="text-l text-blue-950 font-normal gap-30 ">
          ...
          <p className='text-blue-300'>Click on this picture to learn more about how connections supports ones's mental health</p>

        </div>

        <a href='https://www.healthyplace.com/other-info/mental-health-newsletter/connecting-with-others-friendship-enhance-mental-health#connecting'>
          < img className='object-contain place-self-center w-42  h-42' src="https://www.healthyplace.com/sites/default/files/images/stories/other-info/newsletter/connecting-others-mental-health-healthyplace.jpg" alt="connecting with others" />
        </a>
</div>
